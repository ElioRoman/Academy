...
import 'package:flutter_application_1/untilies/dialogs/error_dialog.dart';
import 'package:flutter_application_1/untilies/dialogs/password_reset_email_sent_dialog.dart';
        ...
        if (state is AuthStateForgotPassword) {
          ...
          if (state.exception != null) {
            await showErrorDialog(context,
                'We could not process your request. Please make sure that you a registered user');
          }
        }
      },
      child: Scaffold(
